    ...
    <?php foreach($factures as $facture): ?>
     <tr>
       ...
       <td><?php echo $facture['Montant_TTC'];?></td>
        <td><?php foreach($sites_rec as $site_rec): if($site_rec['Id'] == $facture['Site_Dest']) if($facture['Etat_Dossier']==1) echo $site_rec['Site']; else echo "En cours de transfert vers ".$site_rec['Site']; endforeach; ?></td>
     </tr>
    <?php endforeach; ?>
   </tbody>
</table>
