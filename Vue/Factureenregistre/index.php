...
?>
<!--Vue d'affichage de la liste de toute les factures enregistés-->
...
<table class="table table-bordered table-striped table-hover table-dark">
   ...
   <tbody class="Corp">
    <?php foreach($factures as $facture): ?>
     <tr <?php if ($facture['Etat_Dossier']==2) echo 'style="color: red;"'; ?> >
       ...
       <td><?php echo $facture['Montant_TTC'];?></td>
        <td><?php foreach($sites_rec as $site_rec): if($site_rec['Id'] == $facture['Site_Dest']) if($facture['Etat_Dossier']==1) echo $site_rec['Site']; elseif($facture['Etat_Dossier']==0) echo "En cours de transfert vers ".$site_rec['Site']; else echo "Annulée: ".$facture['Motif']; endforeach; ?></td>
     </tr>
    <?php endforeach; ?>
   </tbody>
</table>
